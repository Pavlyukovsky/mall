            ...
            <div class="col-lg-4 col-lg-offset-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Название</p>
                        <input class="admin_input" type="text" name="name" placeholder="" value="<?php echo $category['name']; ?>">

                        <p>Порядковый номер</p>
                        <input class="admin_input" type="text" name="sort_order" placeholder="" value="<?php echo $category['sort_order']; ?>">
                        
                        <p>Статус</p>
                        <select name="status" class="admin-cat-sel">
