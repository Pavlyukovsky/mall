        ...
        <div class="container">
            <div class="rwo">
                <div class="col-lg-12 content">
                    <h1 style="text-align: center;">Результат поиска</h1>
                    <div class="row product-wrapper">
                        ...
                        <?php if(!$SearchProducts):?>
                            <!-- Error -->
                            <div class="s-img">
                                <img src="template/img/404.png" alt="">
                            </div>
                            <div class="col-lg-12">
                                <div class="s-h">
                                    <h2>Извините, но по вашему запросу нечего не найдено . . .</h2>
                                    <h4>Возможно вы допустили какую либо ошибку, попробуйте что-то другое.</h4>
                                </div>
                            </div>
                            <!-- .# Error -->
                        <?php endif; ?>
